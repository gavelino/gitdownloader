...
//		System.out.println(projectName);
		...
		for (ProjectInfo projectInfo : projectsInfo) {
			if (projectInfo.getName().equalsIgnoreCase("textmate"))
				projectName = projectInfo.getFullName();
			
		}
		
		
		List<CommitFile> cFiles = PrototypeMain.getCommitFiles("gitdownloader", projectName);	
